...
CREATE INDEX IF NOT EXISTS idx_lsh_lead_id   ON lead_score_history(lead_id);
CREATE INDEX IF NOT EXISTS idx_lsh_scored_at ON lead_score_history(scored_at DESC);
CREATE INDEX IF NOT EXISTS idx_lsh_band      ON lead_score_history(score_band);
